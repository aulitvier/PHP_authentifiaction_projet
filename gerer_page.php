...
$ma_requete = $maBDD->prepare("SELECT * FROM page WHERE page_administrateur = ? OR page_utilisateur = ? OR page_invite = ?");
$ma_requete->execute(array(1, 1, 1));
?>
    <h1>Pages</h1>
    <?php
while ($a = $ma_requete->fetch()) {
    ...
    echo "<tr>
            ...
            <td><a href='supprimer_page.php?id=$a[id]'>Supprimer</a>
        </tr>
        <br/>";
};
?>